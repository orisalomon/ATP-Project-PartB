    ...
    public ArrayList<AState> getAllPossibleStates(AState s) {
        ...
        if (pRow-1 >= 0){
            if(tMaze[pRow-1][pCol] == 0){
                posStates.add(new MazeState(new Position(pRow-1,pCol)));
            }
        }
        ...
        if (pCol-1 >= 0){
            if(tMaze[pRow][pCol-1] == 0){
                posStates.add(new MazeState(new Position(pRow,pCol-1)));
            }
        }
        ...
        if (pCol-1 >= 0 && pRow-1 >= 0 && (tMaze[pRow-1][pCol] == 0 || tMaze[pRow][pCol-1] == 0)  && tMaze[pRow-1][pCol-1]== 0 ){
            posStates.add(new MazeState(new Position(pRow-1,pCol-1)));
        }
